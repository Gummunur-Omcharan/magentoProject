...
public class Objects {
    ...
    public void login() {
        ...
        driver.findElement(By.xpath("//input[@id='email']")).sendKeys("Hulksmash19@gmail.com");
        driver.findElement(By.xpath("//input[@name='login[password]']")).sendKeys("HulkNatasha143");
    ...
    public void shippingDetails() throws InterruptedException {
		...
		phoneNumber.sendKeys("1234567893");
